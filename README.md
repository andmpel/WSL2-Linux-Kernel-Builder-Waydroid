...
![kernel-build](https://github.com/andmpel/WSL2-Linux-Kernel-Builder/actions/workflows/build.yml/badge.svg)

This adds USB (usbip) and USB-CAN support to WSL2 Kernel.

+ Download one of the [Kernels](https://github.com/andmpel/WSL2-Linux-Kernel-Builder/actions) (click the latest workflow run)
